...
To replicate the tables and figures, navigate /home/xubuntu/Replication/Paper Results/. These are all R files and can be run within any standard R environment or through the terminal.
